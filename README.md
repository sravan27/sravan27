...
**This week, June 6–7**: 8 PRs shipped at PowerSync (4 merged Sprint #1 + 4 open today — [JOIN loud-error #565](https://github.com/powersync-ja/powersync-service/pull/662), [ASCII upper/lower](https://github.com/powersync-ja/powersync-service/pull/663), [length() code points](https://github.com/powersync-ja/powersync-service/pull/664), [substring() code points](https://github.com/powersync-ja/powersync-service/pull/665) — all same silent-failure class). [9th silent-row-loss fix shipped today at TanStack DB (#1574)](https://github.com/TanStack/db/pull/1574): ASCII case fold in `upper`/`lower`/`ilike` so the JS evaluator agrees with the source DB on `ß`, ligatures, Turkish `İ`. Plus [docs PR at TanStack/cli (#467)](https://github.com/TanStack/cli/pull/467) documenting the four PowerSync footguns in the PowerSync addon generator. 2 PRs at Autumn ([#1838](https://github.com/useautumn/autumn/pull/1838) + [#1839](https://github.com/useautumn/autumn/pull/1839)) both 5/5 from cubic-dev-ai + entelligence-ai. 1 PR at HomeOfferDirect (Sprint 6 hardening). Vercel HackerOne #3750642 disclosure.
